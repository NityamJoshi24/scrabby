...
class GameBoard extends ConsumerWidget{
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return LayoutBuilder(builder: (context, constrains) {
      ...
      ].where((dimension) => dimension.isFinite && dimension > 0).fold<double>(
            constrains.maxWidth,
  ...
  Widget _buildCell(
    ...
    final pendingCell = pendingPlacements.where((c) => c.row == row && c.col == col).firstOrNull;
    ...
    return DragTarget<TileModel>(
      ...
      onAcceptWithDetails: (details) {
        final cell = BoardCellModel(row: row, col: col, tile: details.data, isLocked: false);
        ...
        return AnimatedContainer(duration: Duration(milliseconds: 100),
          decoration: isHovered
            ...
            border: Border.all(color: Colors.white, width: 2),
              ...
              : null,
          child: BoardCell(cell: displayCell, cellSize: cellSize, isPending: isPending,
